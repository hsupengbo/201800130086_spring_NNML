...
from detection.data import VOCDataset
...
pre_weights = "./checkpoints/ctpn_keras_weights.pth.tar" #   从0开始时是ctpn_keras_weights.pth.tar
pretrain =False
...
if __name__ == '__main__':
    ...
    if os.path.exists(checkpoints_weight) and pretrain is True:
    ...
    for epoch in range(resume_epoch + 1, epochs):
        ...
        print("This epoch used time =",(end - start), "sec")
